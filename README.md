...
- **커뮤니티 루프**: 업적, 칭호, 일일/주간 미션, 복권, 서버 이벤트, 활동 요약
- **시즌 시스템**: 일일/주간 시즌 과제, 시즌 포인트, 시즌 랭킹과 보상
- **학교 기능**: NEIS 급식, 자동 급식 알림, 컴시간 시간표, 권한 체크 보강
- **미니게임**: 끝말잇기, 초성게임, 라이어게임, 워들, 숫자야구, 투표, 선택, 궁합, 운세
- **육성·수집**: 희진 다마고치, 낚시/도감/강화/잠수, 검 강화/도감/판매/배틀
- **RPG**: 캐릭터, 사냥, 탐사, 던전, 보스, 레이드, 직업/전직/스킬트리, 제작/거래소, 버튼형 메뉴
...
| `/라이어게임 시작` | 시민과 라이어가 제시어를 설명하고 투표 |
...
| `/rpg 프로필`, `/rpg 인벤토리`, `/rpg 장비`, `/rpg 전리품` | 캐릭터 상태와 아이템 관리 |
| `/rpg 상점`, `/rpg 강화`, `/rpg 제작`, `/rpg 거래소` | 구매, 강화, 제작, 거래 |
| `/rpg 퀘스트`, `/rpg 일일`, `/rpg 휴식` | 퀘스트/일일 의뢰/회복 |
| `/rpg 듀얼직업`, `/rpg 스킬트리`, `/rpg 전직` | 성장 빌드 관리 |
...
| `/주식 주문\|주문취소\|거래내역\|뉴스\|차트` | 주문 관리와 시장 정보 |
...
> 거래가 1개뿐이면 `/주식 레버리지청산`만으로 닫히고, 여러 개면 버튼이나 `대상:1` 같은 번호로 닫을 수 있습니다.
...
/주식 레버리지진입 종목:<자동완성에서 선택> 방향:롱 배율:10 증거금:10000
/주식 레버리지청산
/주식 레버리지청산 대상:1
/카지노정보
/블랙잭 500
