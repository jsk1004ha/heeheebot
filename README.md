...
> 기간 중 변동은 정산하지 않고 만기 턴 가격으로 자동 정산됩니다. 짧은 2~29턴은 1~10배, 30턴 이상은 1~100배까지 가능합니다.
> 만기 손실이 증거금을 넘으면 빌린 명목가를 갚고 남는 부족분이 파산채무로 잡히며, 이후 골드 수익 25%가 자동 상환됩니다.
...
/주식 레버리지진입 종목:<자동완성에서 선택> 방향:롱 배율:10 기간:2 증거금:10000
/주식 레버리지청산
/주식 레버리지청산 대상:1
/카지노정보
/이모지경마 돈:100 선택:강아지
