...
const PRE_MARKET_NEWS_TEMPLATES = Object.freeze({
  positive: Object.freeze({
    stable: Object.freeze([
      '{name}, 배당 정책 검토 자료 공개에 장중 관심이 유입됐습니다',
      '{name}, 실적 설명회 일정 공개 후 거래량이 평소보다 늘었습니다',
      '{name}, 장기 공급 계약 진행 상황 안내에 매수세가 붙었습니다',
      '{name}, 자사주 매입 검토 일정 공지 이후 투자심리가 개선됐습니다',
      '{name}, 핵심 거래처 갱신 협의 일정이 확인되며 강세를 보였습니다',
      '{name}, 비용 효율화 결과 설명회 예고에 수익성 개선 기대가 커졌습니다',
      '{name}, 신규 유통 채널 계약 검토 자료 공개 뒤 관심 주문이 늘었습니다',
      '{name}, 현금흐름 개선 계획 질의응답 일정 공개에 저가 매수세가 유입됐습니다'
    ]),
    growth: Object.freeze([
      '{name}, 신제품 공개 일정 예고에 성장 모멘텀이 부각됐습니다',
      '{name}, 신규 서비스 사전 안내 이후 장중 강세를 나타냈습니다',
      '{name}, AI 협업 질의응답 일정 공개에 관련 기대감이 유입됐습니다',
      '{name}, 베타 테스트 참가자 확대 안내 후 투자심리가 개선됐습니다',
      '{name}, 해외 파트너 실증 일정 공지에 신규 매출 기대가 유입됐습니다',
      '{name}, 구독 지표 설명회 일정 공개 뒤 밸류에이션 재평가가 거론됐습니다',
      '{name}, 신규 기능 로드맵 자료 공개에 성장 경로가 주목받았습니다',
      '{name}, 클라우드 전환 성과 발표 예고 후 매수 호가가 두꺼워졌습니다'
    ]),
    cyclical: Object.freeze([
      '{name}, 신규 수주 협상 진행 상황 공지에 업종 내 매수세가 유입됐습니다',
      '{name}, 원가 구조 점검 자료 공개 뒤 마진 개선 가능성이 거론됐습니다',
      '{name}, 대형 프로젝트 일정 안내에 수주 잔고 기대가 살아났습니다',
      '{name}, 설비 가동률 점검 결과 발표 예고에 장중 관심이 커졌습니다',
      '{name}, 공급망 정상화 설명자료 게시 이후 투자심리가 개선됐습니다',
      '{name}, 수주 잔고 업데이트 일정 공개에 경기민감주 순환매가 붙었습니다',
      '{name}, 원자재 헤지 계획 질의응답 일정에 비용 안정 기대가 커졌습니다',
      '{name}, 해외 프로젝트 현장 점검 일정 안내에 신규 수익원 기대가 유입됐습니다'
    ]),
    volatile: Object.freeze([
      '{name}, 임상 데이터 공개 일정 확정 소식에 장중 관심이 집중됐습니다',
      '{name}, 연구 성과 발표 예고 이후 기술 가치 재평가가 거론됐습니다',
      '{name}, 기술 이전 논의 자료 공개에 거래량이 평소보다 늘었습니다',
      '{name}, 공동 연구 계약 검토 자료 공개 뒤 매수세가 유입됐습니다',
      '{name}, 특허 심사 일정 안내에 중장기 성장성이 부각됐습니다',
      '{name}, 후속 실험 프로토콜 설명회 예고에 개발 일정이 주목받았습니다',
      '{name}, 데이터 검증 회의 일정 공지 뒤 투자심리가 개선됐습니다',
      '{name}, 해외 학회 발표 초록 접수 소식에 연구 파이프라인이 재조명됐습니다'
    ]),
    meme: Object.freeze([
      '{name}, 커뮤니티 협업 이벤트 예고에 단기 매수세가 유입됐습니다',
      '{name}, 신규 굿즈 공개 일정 공개 뒤 거래량이 확대됐습니다',
      '{name}, 유명 스트리머 협업 안내 이후 개인 투자자 관심이 늘었습니다',
      '{name}, 팝업스토어 운영 일정 공개에 브랜드 모멘텀이 부각됐습니다',
      '{name}, SNS 캠페인 사전 티저 공개 후 장중 변동성이 커졌습니다',
      '{name}, 팬 투표 기반 상품 기획안 게시에 테마 매수세가 붙었습니다',
      '{name}, 라이브 커머스 편성표 공개 뒤 단기 수급이 개선됐습니다',
      '{name}, 커뮤니티 AMA 일정 안내에 관심 종목 편입이 늘었습니다'
    ])
  }),
  negative: Object.freeze({
    stable: Object.freeze([
      '{name}, 비용 구조 재점검 자료 공개에 관망세가 확대됐습니다',
      '{name}, 배당 정책 재검토 가능성 공시 이후 차익실현 매물이 출회됐습니다',
      '{name}, 주요 고객사 발주 일정 조율 안내에 단기 실적 변수가 부각됐습니다',
      '{name}, 판매관리비 확대 설명자료 공개 뒤 수익성 부담이 거론됐습니다',
      '{name}, 핵심 거래처 단가 협상 일정 조정에 매수세가 둔화됐습니다',
      '{name}, 재고 회전율 점검 보고서 공개 이후 보수적 주문이 늘었습니다',
      '{name}, 분기 실적 가이던스 보완 자료 공개에 시장 눈높이가 조정됐습니다',
      '{name}, 보수적 투자 집행 계획 안내 뒤 주가가 좁은 범위에서 밀렸습니다'
    ]),
    growth: Object.freeze([
      '{name}, 신사업 출시 일정 지연 가능성 제기에 성장 기대가 일부 후퇴했습니다',
      '{name}, 개발비 집행 계획 변경 공시 이후 수익성 부담이 부각됐습니다',
      '{name}, 경쟁 환경 설명자료 공개 뒤 밸류에이션 부담이 거론됐습니다',
      '{name}, 이용자 성장률 점검 자료 게시에 단기 매수세가 약해졌습니다',
      '{name}, 파트너 계약 조건 재협의 일정 안내 이후 관망 주문이 늘었습니다',
      '{name}, 서버 증설 비용 질의응답 일정에 비용 변수 확인 심리가 커졌습니다',
      '{name}, 신규 서비스 안정화 계획 보완 뒤 성장 속도 검증론이 나왔습니다',
      '{name}, 마케팅 집행 일정 조정 안내에 거래대금이 둔화됐습니다'
    ]),
    cyclical: Object.freeze([
      '{name}, 원자재 조달 비용 점검 자료 공개에 매도 우위가 나타났습니다',
      '{name}, 수주 일정 조정 가능성 전달 이후 실적 가시성이 낮아졌습니다',
      '{name}, 경기 민감도 검토 보고서 공개 뒤 업종 경계 매물이 늘었습니다',
      '{name}, 물류비 변동 설명자료 공개에 원가 부담이 재부각됐습니다',
      '{name}, 주요 현장 납기 일정 재안내 이후 단기 수급이 약해졌습니다',
      '{name}, 설비 보수 기간 연장 가능성 공지에 생산 차질 변수가 거론됐습니다',
      '{name}, 해외 발주처 검수 일정 조정에 수주 인식 시점이 변수로 떠올랐습니다',
      '{name}, 재고 평가손 산정 기준 안내 뒤 실적 눈높이가 낮아졌습니다'
    ]),
    volatile: Object.freeze([
      '{name}, 허가 심사 보완 요청 가능성 제기에 변동성이 확대됐습니다',
      '{name}, 연구비 조달 계획 보완 공시 이후 자금 조달 조건이 주목받았습니다',
      '{name}, 핵심 데이터 공개 지연 가능성에 단기 매수세가 약해졌습니다',
      '{name}, 후속 실험 일정 재조정 안내 뒤 일정 검증 심리가 커졌습니다',
      '{name}, 공동 연구 범위 변경 자료 공개에 파이프라인 가치 평가가 엇갈렸습니다',
      '{name}, 특허 의견서 제출 일정 보완에 관망 주문이 늘었습니다',
      '{name}, 임상 등록 속도 점검 자료 공개 뒤 실적 기여 시점이 늦춰졌습니다',
      '{name}, 외부 검증 보고서 제출 일정 조정에 거래대금이 둔화됐습니다'
    ]),
    meme: Object.freeze([
      '{name}, 커뮤니티 운영 추가 공지 예고에 단기 차익실현 매물이 나왔습니다',
      '{name}, 운영진 해명 공지 예고 뒤 장중 변동성이 커졌습니다',
      '{name}, 밈 캠페인 일정 연기 가능성 제기에 매수세가 둔화됐습니다',
      '{name}, 굿즈 배송 일정 재공지 예고에 테마 매매가 약해졌습니다',
      '{name}, 라이브 방송 편성 변경 안내 이후 단기 수급이 흔들렸습니다',
      '{name}, 팬 이벤트 운영 기준 보완 공지 예고에 관망세가 짙어졌습니다',
      '{name}, SNS 채널 운영 정책 변경 안내에 개인 투자자 주문이 줄었습니다',
      '{name}, 콜라보 상품 검수 일정 조정에 차익실현 물량이 출회됐습니다'
    ])
  }),
  risk: Object.freeze({
    volatile: Object.freeze([
      '{name}, 거래소 확인 자료 제출 일정 공지 뒤 변동성이 커졌습니다',
      '{name}, 핵심 파이프라인 추가 설명자료 공개에 시장 해석이 엇갈렸습니다',
      '{name}, 자금 조달 계획 보완 자료 접수 이후 유동성 점검이 이어졌습니다',
      '{name}, 공시 정정 자료 접수 일정 안내에 투자자 문의가 늘었습니다',
      '{name}, 감사의견 관련 추가 설명자료 게시 뒤 거래가 제한적으로 이뤄졌습니다',
      '{name}, 유통 주식 수 변동 확인 자료 접수에 수급 점검이 진행됐습니다',
      '{name}, 보호예수 해제 일정 안내 뒤 단기 물량 부담이 거론됐습니다',
      '{name}, 외부 평가기관 질의 답변서 접수에 공식 판단을 기다리는 분위기입니다'
    ]),
    meme: Object.freeze([
      '{name}, 거래소 확인 자료 제출 일정 공지 뒤 장중 호가가 흔들렸습니다',
      '{name}, 운영 관련 소명 자료 접수 가능성에 시장 해석이 엇갈렸습니다',
      '{name}, 커뮤니티 집계 방식 추가 설명 공지에 거래량이 불규칙하게 늘었습니다',
      '{name}, 유통 물량 변동 확인 자료 접수에 단기 수급 점검이 이어졌습니다',
      '{name}, 프로모션 정산 기준 설명자료 게시 뒤 투자자 문의가 늘었습니다',
      '{name}, 제휴 채널 운영 자료 제출 일정 안내에 관망세가 짙어졌습니다',
      '{name}, 이벤트 참여 집계 검증 자료 공개에 단기 매매가 빨라졌습니다',
      '{name}, 운영 지표 산정 방식 설명회 예고에 공식 판단을 기다리는 분위기입니다'
    ])
  })
});
...
const PRE_MARKET_NEWS_DETAIL_TEMPLATES = Object.freeze({
  positive: Object.freeze([
    '시장에서는 이번 발표를 중장기 성장성 확인 신호로 해석하고 있습니다',
    '관련 매출이 실제 실적으로 이어지는 시점이 다음 변수로 꼽힙니다',
    '기관성 주문은 제한적이지만 개인 매수세가 먼저 반응한 것으로 풀이됩니다',
    '단기 주가 반응보다 수익성 개선 여부를 확인해야 한다는 평가도 나옵니다'
  ]),
  negative: Object.freeze([
    '시장에서는 단기 비용 부담이 수익성 개선 속도를 늦출 수 있다고 보고 있습니다',
    '회사 측은 세부 영향 범위를 점검한 뒤 추가 자료를 안내할 예정입니다',
    '최근 기대감이 앞서 가격에 담겼던 만큼 차익실현 물량이 일부 출회된 것으로 풀이됩니다',
    '투자자들은 다음 실적 발표에서 실제 기여 규모를 확인하려는 분위기입니다'
  ]),
  risk: Object.freeze([
    '공식 확인 전까지 해석이 엇갈릴 수 있다는 신중론도 나옵니다',
    '거래소와 회사 측은 제출 서류 범위를 확인하고 있습니다',
    '단기 가격 반응보다 후속 공시의 문구와 일정이 핵심 변수로 거론됩니다',
    '투자자 질의는 자료 제출 범위와 유통 물량 변화에 집중됐습니다'
  ])
});

const PRE_MARKET_NEWS_CONTEXT_TEMPLATES = Object.freeze({
  positive: Object.freeze([
    '원/달러 환율과 글로벌 기술주 흐름도 참고 변수로 함께 거론됐습니다',
    '미국 금리 경로와 AI 인프라 투자 확대 흐름이 비교 지표로 제시됐습니다',
    '나스닥 선물과 국내 성장주 수급을 함께 보는 투자자가 늘었습니다',
    '실제 반도체·클라우드 업황 지표와 VX마켓 내부 수급이 나란히 언급됐습니다',
    '가상거래소 VX마켓에서는 관련 업종 전반의 거래대금도 평소보다 늘었습니다'
  ]),
  negative: Object.freeze([
    '유가·운임·환율 같은 실제 거시 변수와 VX마켓 내부 수급이 함께 거론됐습니다',
    '미국 금리 발언과 원자재 가격 흐름이 비교 변수로 제시됐습니다',
    '동종 업종의 실제 뉴스 흐름과 가상 종목별 공시 일정이 함께 거론됐습니다',
    '시장 참가자들은 다음 기준가와 거래량 변화를 확인하며 관망했습니다',
    '가상거래소 VX마켓에서는 방어 주문보다 관망 주문 비중이 커졌습니다'
  ]),
  risk: Object.freeze([
    '거래소 공시 절차와 실제 감사 시즌 일정이 함께 비교됐습니다',
    '유통 물량과 보호예수 해제라는 실제 시장 변수도 참고 항목으로 언급됐습니다',
    '가상거래소 VX마켓에서는 공식 확인 전까지 호가 간격이 넓게 유지됐습니다',
    '시장 참가자들은 후속 자료와 거래 재개 조건을 함께 확인하는 모습입니다',
    '외부 평가 일정과 내부 소명 절차가 동시에 가격 변수로 거론됐습니다'
  ])
});

const MARKET_SUMMARY_TEMPLATES = Object.freeze({
  surge: Object.freeze([
    '시황: {name}, 매수세가 집중되며 상승 폭을 확대했습니다',
    '시황: {name}, 거래량이 평소 대비 크게 늘며 장중 강세를 나타냈습니다',
    '시황: {name}, 성장 모멘텀이 부각되며 수급이 매수 쪽으로 기울었습니다',
    '시황: {name}, 기관성 주문으로 추정되는 물량이 유입되며 호가가 빠르게 움직였습니다',
    '시황: {name}, 종가 부근까지 매수 대기열이 유지되며 강세로 마감했습니다',
    '시황: {name}, {sector} 업종 내 순환매를 이끌며 거래대금이 확대됐습니다'
  ]),
  crash: Object.freeze([
    '시황: {name}, 차익실현 매물이 출회되며 약세를 보였습니다',
    '시황: {name}, 실적 변수 확인 심리가 커지며 매도세가 확대됐습니다',
    '시황: {name}, 장중 반등 시도가 제한되며 낙폭을 줄이지 못했습니다',
    '시황: {name}, 거래량 증가 속에 매도 우위가 나타났습니다',
    '시황: {name}, {sector} 업종 경계 매물에 눌리며 하락 마감했습니다',
    '시황: {name}, 종가 부근 방어 매수가 부족해 변동성이 확대됐습니다'
  ]),
  positive: Object.freeze([
    '시황: {name}, 투자심리가 개선되며 완만한 상승세를 기록했습니다',
    '시황: {name}, 저가 매수세가 유입되며 장중 흐름이 회복됐습니다',
    '시황: {name}, {sector} 업종 선호 흐름을 타며 거래대금이 늘었습니다',
    '시황: {name}, 장 후반 매수 호가가 두꺼워지며 상승 전환했습니다',
    '시황: {name}, 최근 조정분 일부를 되돌리며 보합권 위에서 마감했습니다',
    '시황: {name}, 신규 재료 확인 심리 속에 매수 주문이 완만하게 늘었습니다'
  ]),
  negative: Object.freeze([
    '시황: {name}, 경계 매물이 늘며 약세를 나타냈습니다',
    '시황: {name}, 장중 반등 폭을 대부분 반납하며 하락 전환했습니다',
    '시황: {name}, {sector} 업종 관망세가 짙어지며 거래대금이 줄었습니다',
    '시황: {name}, 단기 매수세가 약해지며 낮은 가격대에서 거래됐습니다',
    '시황: {name}, 종가 부근 매도 호가가 두꺼워지며 약보합권에 머물렀습니다',
    '시황: {name}, 수익성 확인 심리가 커지며 투자자 주문이 둔화됐습니다'
  ]),
  quiet: Object.freeze([
    '시황: {name}, 시장은 발표의 실질적 효과를 지켜보는 분위기입니다',
    '시황: {name}, 보합권에서 거래되며 다음 공시를 기다렸습니다',
    '시황: {name}, 거래 흐름이 안정적으로 유지되며 좁은 범위에서 움직였습니다',
    '시황: {name}, {sector} 업종 평균과 비슷한 흐름을 보였습니다',
    '시황: {name}, 호가 범위가 좁은 채 관망세로 마감했습니다',
    '시황: {name}, 성장 기대와 가격 부담이 동시에 맞물리며 방향성이 제한됐습니다'
  ])
});
...
const MARKET_SUMMARY_CONTEXT_TEMPLATES = Object.freeze({
  ...
  negative: Object.freeze([
    ...
    '실제 원자재 가격과 환율 흐름이 비교 변수로 제시됐습니다',
